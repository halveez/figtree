...
overall_2018 %>% ggplot(aes(x = Day)) + geom_point(aes(y = Rain), color = "lightblue") + geom_point(aes(y = Combined/20), color = "darkgreen") + geom_smooth(aes(y = Energy_Produced_Wh/22000), color = "orange") + theme(axis.title.y = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank()) + ggtitle("2018 Season - Rain, Solar, Air Temp, Fig Count")

#overall_2018 %>% ggplot(aes(x = Day)) + geom_point(aes(y = Ave_Temp_DB))

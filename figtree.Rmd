...
figs_all %>% ggplot() + geom_col(aes(x = Day, y = Combined), color = "darkgreen", fill = "darkgreen", width = 1) + scale_y_continuous(name = "Count") + ggtitle("Home Fig Tree Production Records - Default Width")

figs_all %>% ggplot() + geom_col(aes(x = Day, y = Combined), color = "darkgreen", fill = "darkgreen", width = 3) + scale_y_continuous(name = "Count") + ggtitle("Home Fig Tree Production Records - Increased Width")
...
overall_2018 %>% ggplot(aes(x = Day)) + geom_point(aes(y = Rain), color = "lightblue") + geom_smooth(aes(x = Day, y = Average_T), color = "red", span = 0.2, se = FALSE) + geom_point(aes(y = Combined/20), color = "darkgreen") + geom_smooth(aes(y = Energy_Produced_Wh/22000), color = "orange") + theme(axis.title.y = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank()) + ggtitle("2018 Season - Rain, Solar, Air Temp, Fig Count")
